...
//   Hero → service → about → look → order → works → contact → flow（contact内）→ tel
// TOP はトップページの先頭。ロゴもリンクだが、下層ページでは気づかれにくいため明示する。
// LOOK・ORDER はパララックスの視覚演出（装飾）なのでメニューには載せない
// （2026-09-13 レビューで、セクションではなく装飾として扱うことにした）。
