...
// 企業理念。2026-09-03「HP追加依頼まとめ」で先方から清書された全文が支給された。
// それまで置いていた方向性メモ（COMPANY_KEYWORDS のチップ表示）は役目を終えたので廃止。
export const COMPANY_PHILOSOPHY = [
  "私たちが目指すのは、施工の先にある「感動」をつくることです。",
  "古びた風合いをリアルに表現するエイジング塗装、空間に個性を与える特殊塗装、理想の世界観を造り上げるモルタル造形制作。多彩な職人の経験と柔軟なアイディアを掛け合わせることで、私たちは常に、想像を超える仕上がりに挑戦し続けています。",
  "目に見える美しさはもちろん、そこに流れる空気感や、訪れる人の心に残る印象まで設計することを何より大切にしています。常識にとらわれず、まだ見ぬ表現を形にしていくこと。",
  "これまで出会った皆さまとのご縁、現場ごとに積み重ねてきた時間は、私たちにとって何よりの財産です。時代の変化や新たな感性を前向きに受け止め、確かな技術にさらなる磨きをかけることで、より豊かな空間を生み出していきます。",
